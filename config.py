...
ROOT_EXPLORATION_FRACTION = 0.8
DIRECTIVE_EXPLORATION_FRACTION = 0.0
BOARD_EXPLORATION_FRACTION = 0.9
...
POLICY_HEAD_SIZES = [1+1+1+1]  # [All probabble actions without items]
...
CONCURRENT_GAMES = 1
NUM_PLAYERS = 8
NUM_SAMPLES = 4  # Normal is 25, can be anywhere from 5 to 50
NUM_SIMULATIONS = 30
SAMPLES_PER_PLAYER = 2  # Normal is 128
UNROLL_STEPS = 2
