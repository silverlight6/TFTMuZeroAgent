<script lang="ts">
	...
	export let champion: Champion | null = null;
...
<div class="wrapper">
	{#if champion}
		<img
			class="shop-img border-4"
			style="border-color: {utils.getCostColor(champion)};"
...
<style>
	@import './champion.css';
	.shop-img {
		width: calc(var(--shop-width) * var(--shop-scale));
		height: calc(var(--shop-height) * var(--shop-scale));
	}
</style>
