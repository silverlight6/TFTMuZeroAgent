...
import Simulator.battle.champion as champion
from Simulator.generators.default_agent_stats import *
...
from Simulator.battle.stats import COST, BASE_CHAMPION_LIST
from Simulator.battle.item_stats import starting_items
from copy import deepcopy


class Default_Agent:
    def __init__(self, champ_decider_action_format=False):
    ...
    def policy(self, player, shop, game_round, mask):
        ...
        elif self.champ_decider_action_format:
