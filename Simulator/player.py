...
from Simulator.utils import Encoded_List
...
class Player:
    ...
    def __init__(self, pool_pointer, player_num):
        ...
        self.bench = Encoded_List(9, utils.null_encode)
        # Champion array, this is a 7 by 4 array.
        self.board = [Encoded_List(4, utils.encode_champ_object) for _ in range(7)]
        # List of items, there is no object for this so this is a string array
        self.item_bench = Encoded_List(10, utils.encode_item_object)
    ...
    def player_public_vector(self):
        ...
        output[0:60, :, :] = np.concatenate([self.board[x].get_encoding().reshape((60, 4, 1)) for x in range(0, 7)],
                                            axis=2)
