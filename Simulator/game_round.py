    ...
    def round_1(self):
        for player in self.PLAYERS:
            if player:
                ...
                self.pool_obj.update_champion_pool(ran_cost_1, -1)
    ...
    def carousel2_4(self):
        for player in self.PLAYERS:
            ...
            ran_cost_3 = champion.champion(ran_cost_3,
                                           itemlist=[starting_items[random.randint(0, len(starting_items) - 1)]])
            self.pool_obj.update_champion_pool(ran_cost_3, -1)
        ...
        for player in self.PLAYERS:
            if player:
                ...
                ran_cost_4 = champion.champion(ran_cost_4,
                                               itemlist=[starting_items[random.randint(0, len(starting_items) - 1)]])
                self.pool_obj.update_champion_pool(ran_cost_4, -1)
    ...
    def carousel5_4(self):
        for player in self.PLAYERS:
            if player:
                ...
                self.pool_obj.update_champion_pool(ran_cost_5, -1)
